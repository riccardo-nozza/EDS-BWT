...
int build_MLF(std::string inputFileName){
	...
	//CAMBIARE LA PARTE SOTTO PRATICAMENTE QUANDO VIENE BILANCIATA LA SID NON VENGONO SCRITTE LE LETTERE IN CORRISPONDENZA DEGLI INTERVALLI SPLITTATI, QUINDI VA TUTTO MALE
	//QUINDI MAGARI LEGEGRE IL FILE E CONTROLLARE M_P[I] IN MODO CHE SE INIT POS È ANCORA MINORE RISCRIVO LA STESSA LETTERA DI PRIMA
	//OCCHIO A SE C'È DA MODIFICARE LA SIZE DI L'
	uint64_t i=0;
	uint32_t initPos;
